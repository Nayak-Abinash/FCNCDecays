...
double BdtoKstrll_amperr::ApLRe(double qsq, double ml){
    return nf(qsq,ml)*sqrt(2.0*lambda(qsq))*(((C9effRe(qsq)+C9RHRe())-(C10Re()+C10RHRe()))*V(qsq)/(mBd()+mKst()) + 2.0*mb()/qsq*(C7effRe()+C7RHRe())*T1(qsq));}
double BdtoKstrll_amperr::ApLIm(double qsq, double ml){
    return nf(qsq,ml)*sqrt(2.0*lambda(qsq))*(((C9effIm(qsq)+C9RHIm())-(C10Im()+C10RHIm()))*V(qsq)/(mBd()+mKst()) + 2.0*mb()/qsq*(C7effIm()+C7RHIm())*T1(qsq));}

double BdtoKstrll_amperr::ApRRe(double qsq, double ml){
    return nf(qsq,ml)*sqrt(2.0*lambda(qsq))*(((C9effRe(qsq)+C9RHRe())+(C10Re()+C10RHRe()))*V(qsq)/(mBd()+mKst()) + 2.0*mb()/qsq*(C7effRe()+C7RHRe())*T1(qsq));}
double BdtoKstrll_amperr::ApRIm(double qsq, double ml){
    return nf(qsq,ml)*sqrt(2.0*lambda(qsq))*(((C9effIm(qsq)+C9RHIm())+(C10Im()+C10RHIm()))*V(qsq)/(mBd()+mKst()) + 2.0*mb()/qsq*(C7effIm()+C7RHIm())*T1(qsq));}

double BdtoKstrll_amperr::AaLRe(double qsq, double ml){
...
double BdtoKstrll_amperr::AaLIm(double qsq, double ml){
...
double BdtoKstrll_amperr::AaRRe(double qsq, double ml){
    return -1.0*nf(qsq,ml)*sqrt(2.0)*(pow(mBd(),2.0)-pow(mKst(),2.0))*(((C9effRe(qsq)-C9RHRe())+(C10Re()-C10RHRe()))*A1(qsq)/(mBd()-mKst()) + 2.0*mb()/qsq*(C7effRe()-C7RHRe())*T2(qsq));}
double BdtoKstrll_amperr::AaRIm(double qsq, double ml){
    return -1.0*nf(qsq,ml)*sqrt(2.0)*(pow(mBd(),2.0)-pow(mKst(),2.0))*(((C9effIm(qsq)-C9RHIm())+(C10Im()-C10RHIm()))*A1(qsq)/(mBd()-mKst()) + 2.0*mb()/qsq*(C7effIm()-C7RHIm())*T2(qsq));}

double BdtoKstrll_amperr::AzLRe(double qsq, double ml){
...
double BdtoKstrll_amperr::AzLIm(double qsq, double ml){
...
double BdtoKstrll_amperr::AzRRe(double qsq, double ml){
    return -1.0*nf(qsq,ml)/(2.0*mKst()*sqrt(qsq))*( ((C9effRe(qsq)-C9RHRe())+(C10Re()-C10RHRe()))*16.0*mBd()*mKst()*mKst()*A12(qsq) + 2.0*mb()/(pow(mBd(),2.0)-pow(mKst(),2.0))*(C7effRe()-C7RHRe())*(8.0*mBd()*pow(mKst(),2.0)*(mBd()-mKst())*T23(qsq)) );}
double BdtoKstrll_amperr::AzRIm(double qsq, double ml){
    return -1.0*nf(qsq,ml)/(2.0*mKst()*sqrt(qsq))*( ((C9effIm(qsq)-C9RHIm())+(C10Im()-C10RHIm()))*16.0*mBd()*mKst()*mKst()*A12(qsq) + 2.0*mb()/(pow(mBd(),2.0)-pow(mKst(),2.0))*(C7effIm()-C7RHIm())*(8.0*mBd()*pow(mKst(),2.0)*(mBd()-mKst())*T23(qsq)) );}

double BdtoKstrll_amperr::AtRe(double qsq, double ml){
    return nf(qsq,ml)*sqrt(lambda(qsq)/qsq)*(2.0*(C10Re()-C10RHRe()) + qsq/ml*(CPRe()-CPRHRe()))*A0(qsq);}
double BdtoKstrll_amperr::AtIm(double qsq, double ml){
    return nf(qsq,ml)*sqrt(lambda(qsq)/qsq)*(2.0*(C10Im()-C10RHIm()) + qsq/ml*(CPIm()-CPRHIm()))*A0(qsq);}

double BdtoKstrll_amperr::ASRe(double qsq, double ml){
...
double Bstophill_amperr::ApLRe(double qsq, double ml){
    return nf(qsq,ml)*sqrt(2.0*lambda(qsq))*(((C9effRe(qsq)+C9RHRe())-(C10Re()+C10RHRe()))*V(qsq)/(mBs()+mKst()) + 2.0*mb()/qsq*(C7effRe()+C7RHRe())*T1(qsq));}
double Bstophill_amperr::ApLIm(double qsq, double ml){
    return nf(qsq,ml)*sqrt(2.0*lambda(qsq))*(((C9effIm(qsq)+C9RHIm())-(C10Im()+C10RHIm()))*V(qsq)/(mBs()+mKst()) + 2.0*mb()/qsq*(C7effIm()+C7RHIm())*T1(qsq));}

double Bstophill_amperr::ApRRe(double qsq, double ml){
    return nf(qsq,ml)*sqrt(2.0*lambda(qsq))*(((C9effRe(qsq)+C9RHRe())+(C10Re()+C10RHRe()))*V(qsq)/(mBs()+mKst()) + 2.0*mb()/qsq*(C7effRe()+C7RHRe())*T1(qsq));}
double Bstophill_amperr::ApRIm(double qsq, double ml){
    return nf(qsq,ml)*sqrt(2.0*lambda(qsq))*(((C9effIm(qsq)+C9RHIm())+(C10Im()+C10RHIm()))*V(qsq)/(mBs()+mKst()) + 2.0*mb()/qsq*(C7effIm()+C7RHIm())*T1(qsq));}

double Bstophill_amperr::AaLRe(double qsq, double ml){
...
double Bstophill_amperr::AaLIm(double qsq, double ml){
...
double Bstophill_amperr::AaRRe(double qsq, double ml){
    return -1.0*nf(qsq,ml)*sqrt(2.0)*(pow(mBs(),2.0)-pow(mKst(),2.0))*(((C9effRe(qsq)-C9RHRe())+(C10Re()-C10RHRe()))*A1(qsq)/(mBs()-mKst()) + 2.0*mb()/qsq*(C7effRe()-C7RHRe())*T2(qsq));}
double Bstophill_amperr::AaRIm(double qsq, double ml){
    return -1.0*nf(qsq,ml)*sqrt(2.0)*(pow(mBs(),2.0)-pow(mKst(),2.0))*(((C9effIm(qsq)-C9RHIm())+(C10Im()-C10RHIm()))*A1(qsq)/(mBs()-mKst()) + 2.0*mb()/qsq*(C7effIm()-C7RHIm())*T2(qsq));}

double Bstophill_amperr::AzLRe(double qsq, double ml){
...
double Bstophill_amperr::AzLIm(double qsq, double ml){
...
double Bstophill_amperr::AzRRe(double qsq, double ml){
    return -1.0*nf(qsq,ml)/(2.0*mKst()*sqrt(qsq))*( ((C9effRe(qsq)-C9RHRe())+(C10Re()-C10RHRe()))*16.0*mBs()*mKst()*mKst()*A12(qsq) + 2.0*mb()/(pow(mBs(),2.0)-pow(mKst(),2.0))*(C7effRe()-C7RHRe())*(8.0*mBs()*pow(mKst(),2.0)*(mBs()-mKst())*T23(qsq)) );}
double Bstophill_amperr::AzRIm(double qsq, double ml){
    return -1.0*nf(qsq,ml)/(2.0*mKst()*sqrt(qsq))*( ((C9effIm(qsq)-C9RHIm())+(C10Im()-C10RHIm()))*16.0*mBs()*mKst()*mKst()*A12(qsq) + 2.0*mb()/(pow(mBs(),2.0)-pow(mKst(),2.0))*(C7effIm()-C7RHIm())*(8.0*mBs()*pow(mKst(),2.0)*(mBs()-mKst())*T23(qsq)) );}

double Bstophill_amperr::AtRe(double qsq, double ml){
    return nf(qsq,ml)*sqrt(lambda(qsq)/qsq)*(2.0*(C10Re()-C10RHRe()) + qsq/ml*(CPRe()-CPRHRe()))*A0(qsq);}
double Bstophill_amperr::AtIm(double qsq, double ml){
    return nf(qsq,ml)*sqrt(lambda(qsq)/qsq)*(2.0*(C10Im()-C10RHIm()) + qsq/ml*(CPIm()-CPRHIm()))*A0(qsq);}

double Bstophill_amperr::ASRe(double qsq, double ml){
    return -2.0*nf(qsq,ml)*sqrt(lambda(qsq))*(CSRe()-CSRHRe())*A0(qsq);}
...
double BdtoKll_amperr::xiP(double qsq){return fp(qsq);}

double BdtoKll_amperr::TauPRe(double qsq){
    return xiP(qsq)*(C7effRe() + mBd()/(2.0*mb())*YRe(qsq));}

double BdtoKll_amperr::TauPIm(double qsq){
...
double BdtoKll_amperr::FAIm(double qsq, double ml){
    return (C10Im() + C10RHIm());}

double BdtoKll_amperr::FSRe(double qsq, double ml){
    return 1.0/2.0*(pow(mBd(),2.0)-pow(mK(),2.0))/(mb()-ms())*fz(qsq)/fp(qsq)*(CSRe() + CSRHRe());}
double BdtoKll_amperr::FSIm(double qsq, double ml){
    return 1.0/2.0*(pow(mBd(),2.0)-pow(mK(),2.0))/(mb()-ms())*fz(qsq)/fp(qsq)*(CSIm() + CSRHIm());}

double BdtoKll_amperr::FPRe(double qsq, double ml){
...
double BdtoKll_amperr::FPIm(double qsq, double ml){
